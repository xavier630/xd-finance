...
export const stocks: Record<string, Stock> = {
  ...
  'SAP': {
    ...
    description:
      'SAP SE, together with its subsidiaries, provides applications, technology, and services worldwide. The company operates through Applications, Technology & Services; SAP Business Network; and Customer Experience segments.',
    ceo: 'Christian Klein',
    employees: 107415,
  ...
  'AZN.L': {
    ...
    description:
      'AstraZeneca PLC discovers, develops, manufactures, and commercializes prescription medicines. The company\'s marketed products are used in oncology, rare diseases, cardiovascular, renal and metabolism, respiratory, immunology, and other disease areas.',
    ceo: 'Pascal Soriot',
    employees: 89800,
  ...
  'HSBA.L': {
    ...
    industry: 'Banks - Diversified',
    description:
      'HSBC Holdings plc provides banking and financial services worldwide. The company operates through Wealth and Personal Banking, Commercial Banking, and Global Banking and Markets segments.',
  ...
  '0700.HK': {
    ...
    industry: 'Internet Content & Information',
    description:
      'Tencent Holdings Limited provides value-added services and online advertising services in Mainland China, Hong Kong, and internationally. It operates through VAS, Online Advertising, FinTech and Business Services, and Other segments.',
    ceo: 'Huateng Ma',
    employees: 105417,
  ...
  '9988.HK': {
    ...
    industry: 'Internet Retail',
    description:
      'Alibaba Group Holding Limited provides technology infrastructure and marketing reach to help merchants, brands, retailers, and other businesses engage with users and customers through its ecosystem.',
    ceo: 'Eddie Wu',
    employees: 204891,
    headquarters: 'Hangzhou, China',
    founded: '1999',
    website: 'https://alibabagroup.com',
  },
  'NESN.SW': {
    symbol: 'NESN.SW',
    name: 'Nestlé S.A.',
    ...
    description:
      'Nestlé S.A., together with its subsidiaries, operates as a food and beverage company. The company offers baby foods, bottled water, cereals, chocolate and confectionery, coffee and beverages, dairy products, ice cream, pet care products, and prepared dishes.',
    ceo: 'Laurent Freixe',
    employees: 270000,
...
export const watchlists: Watchlist[] = [
  {
    ...
    name: 'My Watchlist',
    items: [
      { symbol: 'GOOGL', name: 'Alphabet Inc Class A', price: 176.49, change: 2.13, changePercent: 1.22, marketCap: 2180000000000, volume: 28456300, sparklineData: generateSparkline(174, 3), currency: 'USD' },
      { symbol: 'AAPL', name: 'Apple Inc', price: 214.29, change: -2.38, changePercent: -1.10, marketCap: 3290000000000, volume: 54329100, sparklineData: generateSparkline(215, 4), currency: 'USD' },
      { symbol: 'MSFT', name: 'Microsoft Corp', price: 446.34, change: 1.98, changePercent: 0.45, marketCap: 3320000000000, volume: 18923400, sparklineData: generateSparkline(444, 5), currency: 'USD' },
      { symbol: 'AMZN', name: 'Amazon.com Inc', price: 182.81, change: -1.25, changePercent: -0.68, marketCap: 1910000000000, volume: 43218700, sparklineData: generateSparkline(183, 3), currency: 'USD' },
      { symbol: 'NVDA', name: 'NVIDIA Corp', price: 135.58, change: -4.93, changePercent: -3.51, marketCap: 3340000000000, volume: 312456000, sparklineData: generateSparkline(138, 6), currency: 'USD' },
      { symbol: 'META', name: 'Meta Platforms Inc', price: 499.49, change: 7.12, changePercent: 1.45, marketCap: 1280000000000, volume: 15678900, sparklineData: generateSparkline(495, 8), currency: 'USD' },
      { symbol: 'TSLA', name: 'Tesla Inc', price: 184.86, change: -2.59, changePercent: -1.38, marketCap: 590000000000, volume: 87654300, sparklineData: generateSparkline(186, 5), currency: 'USD' },
      { symbol: 'JPM', name: 'JPMorgan Chase & Co', price: 205.42, change: 3.18, changePercent: 1.57, marketCap: 592000000000, volume: 8934200, sparklineData: generateSparkline(203, 3), currency: 'USD' },
      { symbol: 'JNJ', name: 'Johnson & Johnson', price: 156.78, change: 0.42, changePercent: 0.27, marketCap: 378000000000, volume: 6234500, sparklineData: generateSparkline(156, 2), currency: 'USD' },
      { symbol: 'V', name: 'Visa Inc', price: 282.15, change: 1.87, changePercent: 0.67, marketCap: 570000000000, volume: 5678900, sparklineData: generateSparkline(281, 4), currency: 'USD' },
    ],
  },
  {
    id: 'tech',
  ...
  },
  {
    ...
    name: 'International',
    items: [
      { symbol: 'SAP', name: 'SAP SE', price: 237.45, change: 3.82, changePercent: 1.64, marketCap: 292000000000, volume: 3245000, sparklineData: generateSparkline(235, 4), currency: 'EUR' },
      { symbol: 'AZN.L', name: 'AstraZeneca PLC', price: 112.46, change: -0.84, changePercent: -0.74, marketCap: 175000000000, volume: 2156000, sparklineData: generateSparkline(113, 2), currency: 'GBP' },
      { symbol: 'HSBA.L', name: 'HSBC Holdings PLC', price: 7.62, change: 0.08, changePercent: 1.06, marketCap: 148000000000, volume: 18750000, sparklineData: generateSparkline(7.5, 0.15), currency: 'GBP' },
      { symbol: '0700.HK', name: 'Tencent Holdings Ltd', price: 458.60, change: 6.40, changePercent: 1.42, marketCap: 4350000000000, volume: 12450000, sparklineData: generateSparkline(450, 8), currency: 'HKD' },
      { symbol: '9988.HK', name: 'Alibaba Group Holding', price: 127.30, change: -2.10, changePercent: -1.62, marketCap: 2450000000000, volume: 28340000, sparklineData: generateSparkline(128, 3), currency: 'HKD' },
      { symbol: 'NESN.SW', name: 'Nestl\u00e9 S.A.', price: 89.42, change: 0.56, changePercent: 0.63, marketCap: 240000000000, volume: 4560000, sparklineData: generateSparkline(89, 1.5), currency: 'CHF' },
    ],
  },
];
...
export const relatedStocks: Record<string, string[]> = {
  ...
  JNJ: ['JPM', 'V', 'AAPL', 'MSFT'],
  V: ['JPM', 'MSFT', 'AAPL', 'JNJ'],
  SAP: ['MSFT', 'GOOGL', 'AAPL', 'META'],
  'AZN.L': ['JNJ', 'HSBA.L', 'NESN.SW', 'SAP'],
  'HSBA.L': ['JPM', 'V', 'AZN.L', '0700.HK'],
  '0700.HK': ['9988.HK', 'META', 'GOOGL', 'MSFT'],
  '9988.HK': ['0700.HK', 'AMZN', 'META', 'GOOGL'],
  'NESN.SW': ['JNJ', 'AZN.L', 'SAP', 'HSBA.L'],
};
